...
public class TrancheHoraire {
	...
	/**
	 * indique si la tranche horaire objet receveur est contenue dans la tranche
	 * paramètre
	 * 
	 * @param t
	 *            :TrancheHoraire
	...
	// calcule le nombre de partitions induites par la tranche t dans la tranche
	// this
